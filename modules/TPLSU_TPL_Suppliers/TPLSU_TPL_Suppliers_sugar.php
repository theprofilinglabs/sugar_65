 ...
 * PLACE ANY CUSTOMIZATIONS IN TPLSU_TPL_Suppliers
 */

require_once('include/SugarObjects/templates/company/Company.php');

class TPLSU_TPL_Suppliers_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'TPLSU_TPL_Suppliers';
	var $object_name = 'TPLSU_TPL_Suppliers';
	var $table_name = 'tplsu_tpl_suppliers';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function TPLSU_TPL_Suppliers_sugar(){	
		parent::Company();
	}
