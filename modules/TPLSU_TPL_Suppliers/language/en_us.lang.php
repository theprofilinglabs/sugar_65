...
$mod_strings = array (
  ...
  'LBL_REMOVE' => 'Remove',
  'ACCOUNT_REMOVE_PROJECT_CONFIRM' => 'Are you sure you want to remove this  Supplier from this project?',
  'ERR_DELETE_RECORD' => 'A record number must be specified to delete the account.',
  'LBL_ACCOUNT_NAME' => 'Supplier Name:',
  'LBL_ACCOUNT' => 'Company:',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Activities',
  'LBL_ADDRESS_INFORMATION' => 'Address Information',
  'LBL_ANNUAL_REVENUE' => 'Total Value POs:',
  ...
  'LBL_BILLING_ADDRESS_POSTALCODE' => 'Post Code:',
  'LBL_BILLING_ADDRESS_STATE' => 'County:',
  ...
  'LBL_ACCOUNT_INFORMATION' => 'Supplier Information',
  'LBL_CITY' => 'City:',
  ...
  'LBL_VIEW_FORM_TITLE' => 'Supplier View',
  'LBL_WEBSITE' => 'Website:',
  'LNK_ACCOUNT_LIST' => 'Supplier',
  'LNK_NEW_ACCOUNT' => 'Create Account',
  'MSG_DUPLICATE' => 'The supplier record you are about to create might be a duplicate of an account record that already exists. Account records containing similar names are listed below.Click Create Account to continue creating this new account, or select an existing account listed below.',
  ...
  'LNK_IMPORT_TPLSU_TPL_SUPPLIERS' => 'Import Suppliers ',
  'LBL_SEARCH_FORM_TITLE' => 'Search Suppliers ',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'View History',
  'LBL_TPLSU_TPL_SUPPLIERS_SUBPANEL_TITLE' => 'Suppliers ',
  'LBL_NEW_FORM_TITLE' => 'New Suppliers ',
  'LBL_DETAILVIEW_PANEL1' => 'Other Details',
