 ...
 * PLACE ANY CUSTOMIZATIONS IN JAM03_JDB_Contacts
 */

require_once('include/SugarObjects/templates/person/Person.php');

class JAM03_JDB_Contacts_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'JAM03_JDB_Contacts';
	var $object_name = 'JAM03_JDB_Contacts';
	var $table_name = 'jam03_jdb_contacts';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $jobtitleconformed;
		var $contactid;
		var $companyid;
		function JAM03_JDB_Contacts_sugar(){	
		parent::Person();
	}
