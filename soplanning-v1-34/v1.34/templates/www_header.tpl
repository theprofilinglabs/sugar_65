...
<html lang="en">
	...
	<body>
				...
				<div class="navbar-inner">
					<div class="container">
						...
						<ul class="nav pull-right">
							...
							<li>
								<a href="process/login.php?action=logout&language={$lang}"><img src="{$BASE}/assets/img/pictos/logout.png" alt=" " style="height: 20px;"/></a>
							</li>
						</ul>
					</div>
				</div>
		...
		{* cooltip pour les rollover, à laisser ici sinon genere un espace en haut de page *}
