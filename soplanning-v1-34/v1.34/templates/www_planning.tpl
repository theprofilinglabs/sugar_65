			...
			<div class="soplanning-box" style="margin: 0px 10px;">
				<form action="process/planning.php" method="GET" class="form-inline" id="formChoixDates">
					...
					<div class="btn-group" id="dropdownDateSelector">
						<button class="btn dropdown-toggle btn-small" data-toggle="dropdown" style="font-size:15px">{#planning_affichage#} : {$dateDebutTexte} - {$dateFinTexte}&nbsp;&nbsp;&nbsp;<span class="caret"></span></button>
						<ul class="dropdown-menu">
							...
							<li>
								...
								<tr>
									...
									<td valign="top">
										<input name="date_debut_affiche" id="date_debut_affiche" type="text" value="{$dateDebut}" class="input-mini datepicker" style="width:80px;" onChange="$('date_debut_custom').value= '----------------';" />
									...
									<td valign="top">
										<input name="date_fin_affiche" id="date_fin_affiche" type="text" value="{$dateFin}" class="input-mini datepicker" style="width:80px;" onChange="$('date_fin_custom').value= '----------------';" />
									...
									<td valign="top">
										<button class="btn btn-small" style="margin-left:10px;margin-right:10px" onClick="$('formChoixDates').submit();">{#planning_afficher#}</button>
									</td>
								</tr>
								</table>
							</li>
					...
					<div class="btn-group" style="margin-left:20px">
						<a class="btn btn-small" onClick="document.location='process/planning.php?raccourci_date=moisPrecedent';"><i class="icon-backward"></i> {$dateBoutonInferieur}</a>
						<a class="btn btn-small" onClick="document.location='process/planning.php?raccourci_date=moisSuivant';">{$dateBoutonSuperieur} <i class="icon-forward"></i></a>
					</div>
			...
			<div class="soplanning-box" style="margin: 10px;">
				<div class="row-fluid">
					...
					<div class="btn-group">
						...
						{else}
							<a href="?affichageLarge=0" class="btn btn-small" rel="tooltip" title="{#affichageReduit#|escape}"><img align="absbottom" border="0" src="assets/img/pictos/scroll.png"></a>
						{/if}
					</div>
...
function copierTableauPersonnes () {
	...
	document.getElementById('tdUserCopie_0').innerHTML = '<a class="linkSwitchView" id="lienInverse" href="process/planning.php?inverserUsersProjets={/literal}{if $inverserUsersProjets eq 0}1{else}0{/if}{literal}"><img src="assets/img/pictos/switch.png" border="0" /></a>';
