					...
					<tr style="font-weight:bold;">
						...
						<td align="center">
							{if $order eq "livraison"}
								{if $by eq "asc"}
									<a href="?order=livraison&by=desc">{#projet_liste_livraison#}</a>&nbsp;<img src="{$BASE}/assets/img/pictos/asc_order.png" border="0" alt="" />
								{else}
									<a href="?order=livraison&by=asc">{#projet_liste_livraison#}</a>&nbsp;<img src="{$BASE}/assets/img/pictos/desc_order.png" border="0" alt="" />
								{/if}
							{else}
