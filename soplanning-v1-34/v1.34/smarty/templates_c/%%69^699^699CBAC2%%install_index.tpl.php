<?php /* Smarty version 2.6.26, created on 2015-05-05 17:42:17
...
<html>
 ...
 : 5.2
				...
				<?php endif; ?>
				<?php if (isset ( $this->_tpl_vars['checkInstall']['checkWritableDatabaseInc'] )): ?>
					<div class="alert alert-error">
						<?php echo $this->_config[0]['vars']['install_checkWritableDatabaseInc']; ?>

					</div>
				<?php endif; ?>
				<?php if (isset ( $this->_tpl_vars['checkInstall']['checkGD'] )): ?>
					<div class="alert alert-error">
						<?php echo $this->_config[0]['vars']['install_checkGD']; ?>
