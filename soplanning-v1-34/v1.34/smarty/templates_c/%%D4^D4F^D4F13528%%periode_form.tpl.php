...
<?php endif; ?></option>
			...
			<div class="control-group span6">
				<label class="control-label" style="width: 75px;"><?php echo $this->_config[0]['vars']['winPeriode_user']; ?>
 :</label>
...
', WIDTH, 200)"  onmouseout="nd()" href="javascript:undefined;"><i class="icon-question-sign"></i></a> :
...
" class="input-xxlarge"  tabindex="22" />
					<?php if ($this->_tpl_vars['periode']['lien'] != ""): ?>
						<a class="btn btn-small" style="padding-top:4px;" onmouseover="return coolTip('<?php echo ((is_array($_tmp=$this->_config[0]['vars']['winPeriode_gotoLien'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
', WIDTH, 270)"  onmouseout="nd()" href="<?php if (((is_array($_tmp=$this->_tpl_vars['periode']['lien'])) ? $this->_run_mod_handler('strpos', true, $_tmp, 'http') : strpos($_tmp, 'http')) !== 0 && ((is_array($_tmp=$this->_tpl_vars['periode']['lien'])) ? $this->_run_mod_handler('strpos', true, $_tmp, "\\") : strpos($_tmp, "\\")) !== 0): ?>http://<?php endif; ?><?php echo $this->_tpl_vars['periode']['lien']; ?>
" target="_blank"><i class="icon-share"></i></a>
 ...
 :</label>
		...
		<div class="row-fluid">
			<div class="control-group span12">
				<label class="control-label"><?php echo $this->_config[0]['vars']['winPeriode_custom']; ?>
 :</label>
				<div class="controls">
					<input type="text" name="custom" id="custom" size="40" maxlength="255" value="<?php echo $this->_tpl_vars['periode']['custom']; ?>
" class="input-xxlarge"  tabindex="23" />
						<a href="#" onmouseover="return coolTip('<?php echo ((is_array($_tmp=$this->_config[0]['vars']['winPeriode_custom_aide'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?>
...
', $(projet_id).value, $(user_id).value, $(date_debut).value, $(conserver_duree).checked, $(date_fin).value, $(nb_jours).value, $(duree).value, $(heure_debut).value, $(heure_fin).value, $(matin).checked, $(apresmidi).checked, $(repetition).value, $(dateFinRepetition).value, $(appliquerATous).checked, $(statut_tache).value, $(livrable).value, $(titre).value, $(notes).value, $(lien).value, $(custom).value, $(user_id2).value, $(user_id3).value);" />
			<?php if ($this->_tpl_vars['periode']['periode_id'] != 0): ?>
