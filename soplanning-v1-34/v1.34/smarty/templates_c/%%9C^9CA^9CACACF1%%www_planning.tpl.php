<?php /* Smarty version 2.6.26, created on 2015-05-05 17:50:54
         compiled from www_planning.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'www_planning.tpl', 13, false),array('modifier', 'strstr', 'www_planning.tpl', 68, false),array('modifier', 'escape', 'www_planning.tpl', 136, false),array('modifier', 'cat', 'www_planning.tpl', 227, false),array('modifier', 'replace', 'www_planning.tpl', 227, false),array('modifier', 'urlencode', 'www_planning.tpl', 228, false),array('modifier', 'explode', 'www_planning.tpl', 339, false),array('function', 'math', 'www_planning.tpl', 119, false),)), $this); ?>
...
...</option>
					...
					<div class="btn-group" style="margin-left:20px">
						<a class="btn btn-small" onClick="document.location='process/planning.php?raccourci_date=moisPrecedent';"><i class="icon-backward"></i> <?php echo $this->_tpl_vars['dateBoutonInferieur']; ?>
</a>
						<a class="btn btn-small" onClick="document.location='process/planning.php?raccourci_date=moisSuivant';"><?php echo $this->_tpl_vars['dateBoutonSuperieur']; ?>
...
"><img align="absbottom" border="0" src="assets/img/pictos/scroll.png"></a>
						<?php else: ?>
							<a href="?affichageLarge=0" class="btn btn-small" rel="tooltip" title="<?php echo ((is_array($_tmp=$this->_config[0]['vars']['affichageReduit'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><img align="absbottom" border="0" src="assets/img/pictos/scroll.png"></a>
						<?php endif; ?>
					</div>
										<div class="btn-group">
