 ...
 * PLACE ANY CUSTOMIZATIONS IN Jam01_Get_Jamitin_Company
 */

require_once('include/SugarObjects/templates/company/Company.php');

class Jam01_Get_Jamitin_Company_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'Jam01_Get_Jamitin_Company';
	var $object_name = 'Jam01_Get_Jamitin_Company';
	var $table_name = 'jam01_get_jamitin_company';
	...
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		var $jam01_get_jamitin_company_type;
		var $industry;
		var $annual_revenue;
		var $phone_fax;
		...
		function Jam01_Get_Jamitin_Company_sugar(){	
		parent::Company();
	}
